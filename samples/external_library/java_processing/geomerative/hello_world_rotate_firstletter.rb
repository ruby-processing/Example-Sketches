...
def setup
  ...
  fill(255, 102, 0)
  stroke(0)
  # Load the font file we want to use (the file must be in the data folder in
  # the sketch folder),  with the size 72 and the alignment CENTER
...
def draw
  ...
  # Draw the group of shapes representing 'Hola Mundo!' on the PGraphics
  # canvas g (which is the default canvas of the sketch)
  grp.draw
end
